...
class Answer(models.Model):
    ...
    belong_to_type = models.CharField(max_length = 64, choices = ((1, 'pointwise'), (2, 'pairwise'), (3, 'listwise')))
    ...
    absolute_score = models.FloatField(choices = set((i, str(i/10)) for i in range(1, 101)))
